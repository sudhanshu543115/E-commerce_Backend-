...
const HomeSectionCard = ({ product, index }) => {
  ...
  return (
    <div onClick={() => {navigate(`/product/${product.id}`)}} className="pt-5 flex flex-col items-center justify-center bg-white shadow-lg rounded-lg overflow-hidden w-[15rem] mx-3 hover:shadow-xl transition-shadow duration-300 gap-6">
